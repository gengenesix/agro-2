...
export default async function BuyerListingDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-cream pb-24 lg:pb-0">
      {/* Breadcrumb — links back into the buyer sidebar layout */}
      <div className="bg-white border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-1.5 text-xs text-muted-foreground">
          <Link href="/buyer/marketplace" className="hover:text-forest transition-colors">
            Marketplace
          </Link>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm text-muted-foreground
                     hover:text-emerald-700 transition-colors mb-5"
        >
