...
async function fetchListings(filters: Filters) {
  ...
  return { listings: results.slice((page - 1) * limit, page * limit), total, totalPages: Math.ceil(total / limit) }
}

export default async function BuyerMarketplacePage({ searchParams }: PageProps) {
