...
const SECTORS = [
  ...
  },
  {
    ...
    color: 'var(--sector-livestock)',
    bg: 'var(--sector-livestock-bg)',
    icon: (
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor"
           strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    color: 'var(--sector-poultry)',
    bg: 'var(--sector-poultry-bg)',
    icon: (
      <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor"
           strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            {SECTORS.map(s => (
              <StaggerItem key={s.id}>
                <Link href={`/produce?sector=${s.id}`}
                  className="group flex flex-col p-6 h-full transition-all hover:-translate-y-1 cursor-pointer"
                  style={{
            ...
            {TRUST.map(t => (
              <StaggerItem key={t.title}>
                <div
                  ...
                  style={{ backgroundColor: 'white', border: '1.5px solid rgba(25,60,30,0.08)', borderTop: '4px solid var(--forest)' }}
                >
                  <div
                    className="w-11 h-11 flex items-center justify-center flex-shrink-0"
                    style={{
